    ...
    <>
      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {/* Logistic Details */}
          <Text style={styles.title}>Booking & Logistics Coordination</Text>
          <Text style={styles.desc}>
            Streamlined booking system for grave sites, 
            transportation, funeral venues, and all essential 
            services, ensuring timely, respectful arrangements 
