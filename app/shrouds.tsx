    ...
    <>
      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {/* Shroud Details */}
          <Text style={styles.title}>Shroud (Kaffan)</Text>
          <Text style={styles.desc}>
            We provide high-quality islamic burial shrouds for 
            men, women and children. Choose from standard, 
            customized, or donation-based kaffans. 
          </Text>
