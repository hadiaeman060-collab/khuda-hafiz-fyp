    ...
    <>
      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {/* Support Details */}
          <Text style={styles.title}>Emotional Support</Text>
          <Text style={styles.desc}>
            We connect the grieving families with professional 
            therapists for counseling and emotional support, 
            helping them navigate loss with care and 
            compassion. 
          </Text>
